...
https://test-project-1.spinitup.dev
...
3. Set callback URL to `https://test-project-1.spinitup.dev/api/auth/callback/github`
4. Add client ID and secret to environment variables

### Google OAuth
1. Go to Google Cloud Console > APIs & Services > Credentials
2. Create an OAuth 2.0 Client ID
3. Set callback URL to `https://test-project-1.spinitup.dev/api/auth/callback/google`
4. Add client ID and secret to environment variables

## Setting Up Stripe Webhooks

1. Go to Stripe Dashboard > Developers > Webhooks
2. Add endpoint: `https://test-project-1.spinitup.dev/api/webhooks/stripe`
